...
public class TextController : MonoBehaviour {
	...
	private enum States { 
		cell, mirror, sheets_0, lock_0, sheets_1, lock_1, mirror_cell, corridor_0, stairs_0,
	...
	void Update () {
		...
		}else if (myState == States.mirror_cell)   {mirror_cell();
	...
	void in_closet(){
		text.text = "Inside the closet you see a cleaner's uniform that looks about your size! " +
					"Seems your day is looking-up.\n\n"+
					"Press D to Dress up, Press R to return to the corridor";
	...
	void floor(){
		text.text = "Run again around on the dirty floor, you find a hairclip.\n\n"+
	...
	void sheets_0 (){
		text.text = "You can't believe you sleep in these things."+
					"it's time to change them, pleasure of prison life"+
					" welcome to Prison.\n\n" +
	...
	void sheets_1 (){
		text.text = "Holding a mirror in your hand doesn't make the sheets look " +
					...
					" get me out of here.\n\n" +
					" Press R to return to your cell";	
		if (Input.GetKeyDown(KeyCode.R))    {myState = States.mirror_cell;
		}
	}
	void mirror (){
		text.text = "look at you dear."+
					"Hold on this mirror seems loose\n\n"+
					" press T to take the mirror"+
					 " or Press R to return to your cell";	
		if 	(Input.GetKeyDown(KeyCode.R))    {myState = States.cell;
		}else if (Input.GetKeyDown(KeyCode.T))   {myState = States.mirror_cell;
		}
	}
	void mirror_cell (){
		text.text = "aieiaie."+
					"we are still in the cell, There are " +
	...
	void lock_0 (){
		text.text = "This is one of those lock you need the combination."+
					"i wish we coul see where the dirty fingerprints were"+
					"it could help us\n\n"+
					" Press R to return to your cell";	
		if (	Input.GetKeyDown(KeyCode.R))    {myState = States.cell;
		}
	...
	void corridor_0  (){
		text.text = "You're out of your cell, but not out of trouble." +					" welcome out of your cell.\n\n" +
